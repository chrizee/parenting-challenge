...
@section('content')
    <div class="row" style="margin-left: 15px; margin-bottom: 1em;">
        <a href="/admin/parentpsychology"><button class="btn btn-sm btn-default"><i class="fa fa-arrow-circle-left"></i> Back</button></a>
    </div>
    <section class="col-lg-7 connectedSortable">
        <div class="box box-primary">
            ...
            <div class="box-body">
                {!! Form::open(['action' => 'ParentPsychologiesController@store', 'method' => "POST", 'enctype' => 'multipart/form-data']) !!}
