...
@section('content')
    ...
    <section class="col-lg-7 connectedSortable">
        <div class="box box-primary">
            ...
            <div class="box-body">
                {!! Form::model($parentingQuiz, ['action' => ['ParentingQuizzesController@update', $parentingQuiz->id], 'method' => "POST"]) !!}
                ...
                <div class="options">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            {{Form::text('optionD', $parentingQuiz->optionD, ['class' => 'form-control'])}}
                        </div>
                    </div>
                </div>
                ...
                <div class="options">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            {{Form::text('optionE', $parentingQuiz->optionE, ['class' => 'form-control'])}}
                        </div>
                    </div>
                </div>
