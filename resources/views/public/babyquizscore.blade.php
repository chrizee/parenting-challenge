...
@section('content')
    <div class="fh5co-section-with-image">
        ...
        <div class="fh5co-box animate-box">
            ...
            @endif
            <p><a href="{{ route('babyquiz') }}" class="pull-right btn btn-primary btn-outline with-arrow">Take quiz again<i class="icon-arrow-right"></i></a></p>
        </div>
    ...
    <div id="best-deal">
        <div class="container">
            <div class="row text-center">
                <h3 class="text text-danger">Baby Quiz Review</h3>
                @empty(!$babyQuiz)
                ...
                @empty(!$babyQuiz)
                    @foreach ($babyQuiz as $key => $value)
                        ...
                        <div class="ques2 col-md-12">
                            <div class="col-md-8">
                                <p class="text text-center">{{ ($key+1)." of ".count($babyQuiz) }}</p>
                                <div class="form-group">
                    ...
                    @endforeach
                @else
                    <h5 class="text text-center text-danger">You didn't answer any question. <a href="{{ route('babyquiz') }}">Take quiz again.</a></h5>
                @endempty
            </div>
        </div>
    </div>
