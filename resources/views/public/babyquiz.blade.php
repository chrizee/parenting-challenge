                ...
                <div class="col-md-11 animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co-entry" style="width:100%;">
                        <div class="fh5co-copy">
                            {!! Form::open(['action' => 'Visitors\BabyQuizController@mark', 'method' => "POST", 'id' => 'test']) !!}
                            <legend>Baby Quiz <span class=" pull-right"><i class="fa fa-clock-o text-danger"></i>
                                ...
                                @foreach ($babyQuiz as $key => $value)
                                    ...
                                    <div class="ques @if(!$loop->first) hidden @endif ">
                                        <div class="visible-xs">
                                            <figure>
                                                <picture>
                                                    <source srcset="/storage/quiz/baby/{{ $value->image }}" type="image/webp">
                                                    <source srcset="/storage/quiz/baby/{{ explode('.', $value->image)[0].'.jpg' }}" type="image/jpeg">
                                                    <img src="/storage/quiz/baby/{{ explode('.', $value->image)[0].'.jpg' }}" class="img-responsive" alt="question image" />
                                                </picture>
                                            </figure>
                                        </div>
                                        <div class="col-md-6">
